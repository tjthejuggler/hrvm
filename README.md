...
- **`src/gui/charts.py`**: Collapsible chart widgets: BiofeedbackChart, HeartbeatChart, TachogramChart, PoincareChart, RMSSDHistoryChart, SDNNHistoryChart, CoherenceHistoryChart, ACCChart, ECGChart. Also contains the device-agnostic HRV section charts: `HRVTachogramChart`, `HRVPoincareChart`, `HRVRMSSDChart`, `HRVSDNNChart`, `HRVCoherenceChart` — all with 60s scrolling windows.
